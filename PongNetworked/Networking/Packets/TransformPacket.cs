...
namespace Pong.Networking.Packets
{
	...
	public class TransformPacket() : Packet(ID_NAME)
	{
		...
		public override Task Process()
		{
			...
			if (Network<PongNetworkPlayer>.Instance == null)
			{
			...
			if (Network<PongNetworkPlayer>.Instance.HasAuthority)
			{
				((NetworkServer<PongNetworkPlayer>)Network<PongNetworkPlayer>.Instance).BroadcastPacket(
